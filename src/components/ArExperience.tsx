...
export function ArExperience() {
  ...
  return (
    <div className="relative h-full w-full bg-black text-white">
      <div
        ref={containerRef}
        className={`relative h-full w-full overflow-hidden ${isActive ? '' : 'invisible'}`}
      ...
      {!isActive && (
        <div className="absolute inset-0 z-50 flex flex-col items-center justify-center gap-6 bg-black px-6 text-center">
